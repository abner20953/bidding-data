...
# v59：评审审查结果新增 requirement_relation 结构化协议（supports/contradicts/uncertain），
# 状态不再由理由关键词反推；含“符合禁止情形”类直接反证保留。
EVALUATION_PROMPT_VERSION = "vision-evidence-contract-v59"
