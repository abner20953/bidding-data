...
_EXTRACT_RULES_TECHNICAL_COVERAGE_GUIDANCE = (
    ...
    "归并，通常每个采购包控制为1至3条规则，并在 check_rule 中完整列出叶子要求及原编号；"
