...
class CollusionDetector:
    ...
    def find_collisions(self, path_a, path_b, check_entity=True, check_text=True, check_spelling=False):
        """
        核心比对逻辑
        """
...
def compare_documents(path_a, path_b, path_tender=None, check_entity=True, check_text=True, check_spelling=False):
    detector = CollusionDetector(path_tender)
    return detector.find_collisions(path_a, path_b, check_entity=check_entity, check_text=check_text, check_spelling=check_spelling)
